...
(function(exports) {
  ...
  var configureServices = require('./laravel/services').configureServices;
  var configureViewComposers = require('./laravel/composers').configureViewComposers;
  var integrateEmailBoilerplate = require('./laravel/emailBoilerplate').integrateEmailBoilerplate;
  var integrateCachebuster = require('./laravel/cachebuster').integrateCachebuster;
  var dontIgnoreComposerLockFile = require('./laravel/gitignore').dontIgnoreComposerLockFile;
  var integrateBladeCacheFilter = require('./laravel/bladeCache').integrateBladeCacheFilter;
        ...
        prompts.push({
          ...
          warning: 'Must be zero or more space-separated hostname patterns.',
            'default': init.defaults['environment-' + environment] || (environment === 'local' ?
              'localhost *.dev *.dev:* *.local *.localhost.com' : 'your-' + environment + '-host.com'),
          // Split the string on spaces.
  ...
  exports.template = function(grunt, init, done) {
    ...
    var tasks = [
      ...
      configureServices,
      configureViewComposers,
      integrateEmailBoilerplate,
      integrateCachebuster,
      dontIgnoreComposerLockFile,
      integrateBladeCacheFilter
    ];
