  ...
  exports.integrateCachebuster = function(grunt, init, done) {
    ...
    content = grunt.file.read('build/app/routes.php') +
      ...
      "Route::group(array('before' => 'cache', 'after' => 'cache'), function() {\n\n" +
        ...
        // TODO:
        // This is a temporarly fix for the monkeytestjs integration. should look at a way to fix it.
        "\tRoute::get('/tests/core/css/{filename}.css', function($filename) {\n" +
          "\t\treturn Bust::css(\"/tests/core/css/$filename.css\");\n" +
        "\t});\n\n" +
        "\tRoute::get('/tests/core/css/vendor/{filename}.css', function($filename) {\n" +
          "\t\treturn Bust::css(\"/tests/core/css/vendor/$filename.css\");\n" +
        "\t});\n\n" +
      "});\n" +
